repeat
    wait()
until game:IsLoaded()
if game.PlaceId == 113555614146175 then
    World1 = true
...
local Window = Fluent:CreateWindow({
    Title = "Cheems Hub | No Pro Beta=))",
    SubTitle = "Nhìn Cái Choá Gì",
    TabWidth = 110,
	...
	function CheckQuest() 
        ...
        elseif AnDepZai2 then
            ...
            elseif MyLevel == 775 or MyLevel <= 799 then
                ...
                CFrameMon = CFrame.new(1068.664306640625, 137.61428833007